...
public enum UnitOfMeasure {
    ...
    private UnitOfMeasure(String quantity, String name) {
    ...
    public static UnitOfMeasure valueOfLowerHyphen(String name) {
        return UnitOfMeasure.valueOf(LOWER_HYPHEN.to(UPPER_UNDERSCORE, name));
    }
}
